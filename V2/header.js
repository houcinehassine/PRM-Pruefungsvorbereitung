      ...
      <header class="header">
        <div class="header-inner container">
          ...
          <nav class="chapter-nav-top" aria-label="Kapitelnavigation">
            <a href="../Kapitel1Page1.html" ${page === 'page1' ? 'class="active"' : ''}>1</a>
            <a href="../Kapitel2Page1.html" ${page === 'page2' ? 'class="active"' : ''}>2</a>
            <a href="../Kapitel3Page1.html" ${page === 'page3' ? 'class="active"' : ''}>3 – Klassifikation</a>
            <a href="../Kapitel4Page1.html" ${page === 'page4' ? 'class="active"' : ''}>4 – Clustering</a>
            <a href="../Kapitel5Page1.html" ${page === 'page5' ? 'class="active"' : ''}>5 - Random Forest</a>
            <a href="../Kapitel6Page1.html" ${page === 'page6' ? 'class="active"' : ''}>6 - Deep Learning</a>
            <a href="../Kapitel7Page1.html" ${page === 'page7' ? 'class="active"' : ''}>7 - Reinforcement Learning</a>
          </nav>
